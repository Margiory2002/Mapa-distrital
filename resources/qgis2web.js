...
map.getView().fit([-8869721.134669, -1731085.658927, -7756642.451972, -1426525.216727], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Distritos del departamento de Ica</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (98 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este mapa fue elaborado para identificación de distritos<br />UPN-2025<br />Margiory Dayana Flores Gutierrez';
            }
